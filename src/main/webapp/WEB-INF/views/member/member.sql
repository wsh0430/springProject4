CREATE TABLE `member` (
	...
	`likeTeam` VARCHAR(10)  DEFAULT '선택안함' COMMENT '좋아하는 팀 선택' COLLATE 'utf8mb4_0900_ai_ci',
	...
	`login_token` varchar(255) COMMENT '자동 로그인 토큰',
	`token_expiry` DATETIME COMMENT '토큰 만료 시간',
